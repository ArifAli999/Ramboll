...
// Modal provided by HeadlessUI. 



function MyDialog({ user }) {
                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all relative">
                                    <Dialog.Title
                                        as="div"
                                        className=" font-medium mb-4 leading-6 text-gray-900 flex flex-row gap-2 items-center"
                                    >
                                        <img src={user && user.picture.large} className='rounded-full object-cover w-30 h-30' />
                                        <div className='flex flex-col '>
                                            <h3 className='text-lg'> {user && user.name.first + ' ' + user.name.last}
                                            </h3>
                                            <h4 className='text-gray-400 text-xs font-normal'>Joined {user && user.registered.age} years ago <br />{Date(user && user.registered.date)}</h4>
                                        </div>
